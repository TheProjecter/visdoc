...
Random.between(8, 19, true);';
	...
	my $result = $text;
	my $expected = '<span class="codeComment">// returns a float between 8 and 19, for example 7.87623</span>
...
sub test_colorizeCode_2 {
	...
	my $result = $text;
	my $expected = 'the numbers #ff0000, <span class="codeNumber">%26</span> <span class="codeKeyword">and</span> <span class="codeNumber">&amp;#0123</span>;';
...
Random.Object(["string1","string2","string3","string4"]);';
	...
	my $result = $text;
	my $expected = '<span class="codeComment">//returns &quot;string1&quot;,&quot;string2&quot;,&quot;string3&quot; or &quot;string4&quot; </span>
