...
our $STUB_COLORIZE_CODE_COMMENT_START = 'VISDOC_STUB_COLORIZE_CODE_COMMENT_START';
our $STUB_COLORIZE_CODE_COMMENT_END = 'VISDOC_STUB_COLORIZE_CODE_COMMENT_END';
our $STUB_COLORIZE_CODE_KEYWORD_START = 'VISDOC_STUB_COLORIZE_CODE_KEYWORD_START';
our $STUB_COLORIZE_CODE_KEYWORD_END = 'VISDOC_STUB_COLORIZE_CODE_KEYWORD_END';
our $STUB_COLORIZE_CODE_IDENTIFIER_START = 'VISDOC_STUB_COLORIZE_CODE_INDENTIFIER_START';
our $STUB_COLORIZE_CODE_IDENTIFIER_END = 'VISDOC_STUB_COLORIZE_CODE_INDENTIFIER_END';
our $STUB_COLORIZE_CODE_PROPERTY_START = 'VISDOC_STUB_COLORIZE_CODE_PROPERTY_START';
